...
def main() -> None:
    ...
    source_url = os.environ["DVLA_VEH1103_URL"]
    ...
    raw_filename = "dvla_veh1103.ods"
    prepared_filename = "prepared_dvla_veh1103.parquet"
    ...
    print("Downloading DVLA VEH1103 source file...")
    ...
    upload_file_to_gcs(
        ...
        destination_blob_name=f"raw/dvla_veh1103/{raw_filename}",
    )
    ...
    upload_file_to_gcs(
        ...
        destination_blob_name=f"prepared/dvla_veh1103/{prepared_filename}",
    )
    ...
    print("DVLA VEH1103 ingestion complete.")
