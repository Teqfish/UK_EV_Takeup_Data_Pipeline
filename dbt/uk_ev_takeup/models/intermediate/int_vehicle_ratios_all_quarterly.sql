-- #### === QUARTERLY ALL VEHICLE RATIOS === ####
-- Pivot the long all-vehicle registrations table wide,
...
select
    ...
    safe_divide(plugin_registered_licenses, fossil_registered_licenses) * 100 as all_plugin_fossil_ratio
